...
class BiaffineDependencyParserPredictor(Predictor):
    ...
    def predict_instance(self, instance: Instance) -> JsonDict:
        ...
        new_outputs = {}
        new_outputs["words"] = outputs["words"]
        new_outputs["predicted_heads"] = outputs["predicted_heads"]
        new_outputs["predicted_dependencies"] = outputs["predicted_dependencies"]
        new_outputs["pos"] = outputs["pos"]
