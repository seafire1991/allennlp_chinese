...
// (https://arxiv.org/abs/1804.09541).
{
    ...
    "vocabulary": {
        ...
        "pretrained_files": {
            ...
            "tokens": "/media/kxf/软件/input_dir/datasets/GLOVE-42B-300D/sgns.baidubaike.bigram-char"
        },
        "only_include_pretrained_words": true
    },
    "train_data_path": "/media/kxf/软件/input_dir/datasets//dureader/train.json",
    "validation_data_path": "/media/kxf/软件/input_dir/datasets/dureader/dev.json",
    "model": {
        "type": "c_qanet",
        "text_field_embedder": {
            "token_embedders": {
                "tokens": {
                    "type": "embedding",
                    "pretrained_file": "/media/kxf/软件/input_dir/datasets/GLOVE-42B-300D/sgns.baidubaike.bigram-char",
                    "embedding_dim": 300,
                    "trainable": false
                },
                "token_characters": {
