...
def allowed_transitions(constraint_type: str, labels: Dict[int, str]) -> List[Tuple[int, int]]:
    ...
    for from_label_index, from_label in labels_with_boundaries:
        if from_label in ("START", "END"):
            ...
            from_entity = from_label[0]
            from_tag = "o" if from_label == "o" else from_label[2:]
        #print(from_tag + "_" + from_entity )
        for to_label_index, to_label in labels_with_boundaries:
            ...
            if to_label in ("START", "END"):
                ...
                to_tag = "o" if to_label == "o" else to_label[2:]
                to_entity = to_label[0]
...
# labels = {0: 'o', 1: 'a-M', 2: 'b-B', 3: 'b-E', 4: 'a-B', 5: 'a-E', 6: 'c-B', 7: 'c-E', 8: 'c-M', 9: 'b-M', 10: 'b-S', 11: 'c-S', 12: 'a-S'}
# print(allowed_transitions("BMESO",labels))
# import sys
# sys.exit()
