...
@DatasetReader.register("c_uni_sdp")
class UniDependenciesDatasetReader(DatasetReader):
    """
    ...
    def _read(self, file_path: str):
        ...
        with open(file_path, 'r', encoding="utf-8") as conllu_file:
            logger.info("Reading Semeval instances from conllu dataset at: %s", file_path)
